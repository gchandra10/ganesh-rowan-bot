...
It is built specifically for students enrolled in courses taught by
<strong>Ganesh Chandrasekaran</strong> and uses only the documents provided for those classes.
</div>
""", unsafe_allow_html=True)
...
<div style="
    ...
    line-height: 1.4;
">
<strong>Disclaimer.</strong> This response is generated by an AI system using documents provided for some of the recent courses. 

The system is still in early development. If you are unsure about the answer or need clarity for academic or policy decisions, contact <strong>Ganesh Chandrasekaran</strong> directly.
</div>
""", unsafe_allow_html=True)
